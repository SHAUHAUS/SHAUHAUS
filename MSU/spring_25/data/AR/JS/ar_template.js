...
function preload(){
	img = loadImage('P1_JoshStephens_WS2_all.png');
	img1 = loadImage('P1_JoshStephens_WS2_small_symbols.png');
	img2 = loadImage('P1_JoshStephens_WS2_large_symbols.png');
    img3 = loadImage('P1_JoshStephens_WS2_Mary.png');
