...
function preload(){
	...
	img1 = loadImage('data/img2.png');
	img2 = loadImage('data/img3.png');
	img3 = loadImage('data/img4.png');
...
function draw(){
	...
	arLayers[2] = createGraphics(895, 1350, document.getElementById('canvas-ar4')) // poster aspect
